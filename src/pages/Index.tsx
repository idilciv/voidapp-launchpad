        ...
        >
          <div className="relative w-[500px] md:w-[620px]">
            ...
            <img
              ...
              style={{
                maskImage: "radial-gradient(ellipse 62% 72% at 55% 52%, black 58%, transparent 68%)",
                WebkitMaskImage: "radial-gradient(ellipse 62% 72% at 55% 52%, black 58%, transparent 68%)",
